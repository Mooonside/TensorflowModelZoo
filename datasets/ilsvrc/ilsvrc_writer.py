...
flags.DEFINE_string('train_directory',
                    '/mnt/ftp/datasets/ImageNet/ISVRC2015/challenge/dataset/CLS-LOC/ILSVRC2015_CLS-LOC/Data/CLS-LOC/train/',
                    'Training data directory')
flags.DEFINE_string('validation_directory',
                    '/mnt/ftp/datasets/ImageNet/ISVRC2015/challenge/dataset/CLS-LOC/ILSVRC2015_CLS-LOC/Data/CLS-LOC/val/',
                    'Validation data directory')
flags.DEFINE_string('output_directory',
                    '/data/chenyifeng/TF_Records/ILSVRC_2015_CLS/train',
...
flags.DEFINE_string('bounding_box_file',
                    '/home/chenyifeng/imagenet_2012_bounding_boxes.csv',
                    'Bounding box file')
